...
function checkResult(player, ai) {
    ...
    if (player === ai) {
        return 'paint';
    } else if ((player === "paper" && ai === "rock") || (player === "rock" && ai === "") || (player === "scissors" && ai === "paper")) {
        return 'win';
    } else { return 'loss'; }
}
...
function publishResult(player, ai, result) {
    ...
    document.querySelector('p.numbers span').textContent = ++allGames.numbers;

    if (result === "win") {
        document.querySelector('p.wins span').textContent = ++allGames.wins;
        ...
        document.querySelector('p.losses span').textContent = ++allGames.losses;
        document.querySelector('[data-summary="who-win"]').textContent = "Computer win! :("
        document.querySelector('[data-summary="who-win"]').style.color = "red";
    } else {
        document.querySelector('p.draws span').textContent = ++allGame.draws;
